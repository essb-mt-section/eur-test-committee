...
3. The method uses a bi-linear interpolation. That is, one interpolation for all score between the pass-fail criterion (see above) and separate linear interpolation for the scores between the guessing rate and the pass-fail criteria. 
